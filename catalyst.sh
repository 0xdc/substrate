...
case "$arch" in
x86_64)
	targets="${TARGETS:-systemd:stage1 systemd:stage2 systemd:stage3 router:stage4 systemd:stage4 sso:stage4 plasma:stage2 plasma:stage3 plasma:stage4 plasma-sso:stage4 dev:stage4 browsers:stage4}"
	upstream="amd64"
